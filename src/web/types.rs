...
pub struct AdminConfigUpdateRequest {
    ...
    pub arxiv_cache_ttl_hours: Option<usize>,
...
pub struct ProviderUpdateRequest {
    ...
    #[serde(default)]
    pub reasoning_effort: String,
    /// Sampling temperature; empty string = unset (use server default).
    #[serde(default)]
    pub temperature: String,
    /// Nucleus-sampling cutoff; empty string = unset (use server default).
    #[serde(default)]
    pub top_p: String,
    #[serde(default)]
    pub is_digest: String,
